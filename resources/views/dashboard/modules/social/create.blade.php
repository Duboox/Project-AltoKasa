                        ...
                        <div class="row">
                            <div class="col-sm-6 b-r">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="name" placeholder="Ej: Facebook" class="form-control">
                                  @if ($errors->has('name'))
                                  ...
                                  @endif
                                    ...
                                    <div class="form-group">
                                      <label>Link</label> 
                                      <input type="url" name="link" placeholder="Ej: https://www.facebook.com" class="form-control">
                                  ...
                                  @endif
                                    ...
                                    <div class="form-group">
                                      <label>Icon</label> 
                                      <input type="text" name="icon" placeholder="Ej: facebook" class="form-control">
                                  ...
                                  @endif
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="title" placeholder="Ej: Siguenos en Facebook" class="form-control">
                                  @if ($errors->has('title'))
                                    <span class="error-validate">
